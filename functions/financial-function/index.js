...
const FALLBACK_FINANCIAL_GRAPH = {
  nodes: [
    { id: 'ACC-8821', label: 'Ramesh Kumar\n(Accused)', type: 'accused', color: '#f87171', shape: 'dot', size: 25 },
    { id: 'ACC-9912', label: 'Account 987112001\n(HDFC Bank)', type: 'account', color: '#38bdf8', shape: 'diamond', size: 22 }
  ],
  edges: [
    { from: 'ACC-8821', to: 'ACC-9912', label: 'Primary Holder' }
  ],
  transactions: [
    { id: 'TX-101', fromAccount: '987112001', toAccount: '441009123', amount: 1250000, date: '2024-04-12', isSuspicious: true }
  ]
};
...
async function handler(a, b, c) {
  ...
  if (typeof res.status === 'function') return res.status(200).json(FALLBACK_FINANCIAL_GRAPH);
  return FALLBACK_FINANCIAL_GRAPH;
}
